        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          ...
          <div className="flex-1 overflow-y-auto">
            <nav className="mt-5 px-2">
              <Link href="/dashboard" className={cn("group flex items-center px-2 py-2 text-base font-medium rounded-md", pathname === '/dashboard' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900')} onClick={() => setSidebarOpen(false)}>
                ...
                <div className="mt-3">
                  ...
                  {openTesouraria && (
                    <div className="mt-1 space-y-1 pl-8">
                      {hasLaunchPermission && (<Link href="/launches" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/launches' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><List className="mr-3 h-5 w-5 shrink-0" />Lançamentos</Link>)}
                      {hasSummaryPermission && (<Link href="/congregation-summary" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/congregation-summary' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><PieChart className="mr-3 h-5 w-5 shrink-0" />Resumo Diário</Link>)}
                      ...
                      {hasGenerateReport && (
                        <div className="mt-1">
                          ...
                          {openReports && (
                            <div className="mt-1 space-y-1 pl-8">
                              {canReportLaunches && <Link href="/reports/launches" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/reports/launches' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Printer className="mr-3 h-5 w-5 shrink-0" />Relatório de Lançamentos</Link>}
                              {canReportContributors && <Link href="/reports/contributors" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/reports/contributors' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Printer className="mr-3 h-5 w-5 shrink-0" />Relatório de Contribuintes</Link>}
                              {canReportMonthlySummary && <Link href="/reports/monthly-summary" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/reports/monthly-summary' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Printer className="mr-3 h-5 w-5 shrink-0" />Resumo Mensal</Link>}
                      ...
                      {session?.user?.canExport && (<Link href="/export" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/export' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Download className="mr-3 h-5 w-5 shrink-0" />Exportar Dados</Link>)}
                      {session?.user?.canDelete && (<Link href="/delete-history" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/delete-history' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Trash2 className="mr-3 h-5 w-5 shrink-0" />Excluir Histórico</Link>)}
                    </div>
                  )}
                </div>
              )}
              ...
              {canCreate && (
                <div className="mt-3">
                  ...
                  {openCadastros && (
                    <div className="mt-1 space-y-1 pl-8">
                      <Link href="/contributors" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/contributors' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><User className="mr-3 h-5 w-5 shrink-0" />Contribuintes</Link>
                      <Link href="/congregations" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/congregations' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Building2 className="mr-3 h-5 w-5 shrink-0" />Congregações</Link>
                      <Link href="/suppliers" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/suppliers' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Building className="mr-3 h-5 w-5 shrink-0" />Fornecedores</Link>
                      <Link href="/classifications" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/classifications' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><ListCheck className="mr-3 h-5 w-5 shrink-0" />Classificações</Link>
                    </div>
                  )}
                </div>
              )}
              ...
              <div className="mt-3">
                ...
                {openSeguranca && (
                  <div className="mt-1 space-y-1 pl-8">
                    {canManageUsers && <Link href="/users" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/users' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><Users className="mr-3 h-5 w-5 shrink-0" />Usuários</Link>}
                    {canManageUsers && <Link href="/profiles" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/profiles' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><UserPen className="mr-3 h-5 w-5 shrink-0" />Perfis</Link>}
                    <Link href="/profile" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/profile' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')} onClick={() => setSidebarOpen(false)}><UserCheck className="mr-3 h-5 w-5 shrink-0" />Acesso</Link>
                  </div>
                )}
              </div>
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
          ...
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            <nav className="mt-5 flex-1 space-y-1 px-2">
              <Link href="/dashboard" className={cn("group flex items-center px-2 py-2 text-sm font-medium rounded-md", pathname === '/dashboard' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900')}>
              ...
              {(hasLaunchPermission || hasSummaryPermission || hasGenerateReport) && (
                <div className="mt-3">
                  ...
                  {openTesouraria && (
                    <div className="mt-1 space-y-1 pl-8">
                      {hasLaunchPermission && (<Link href="/launches" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/launches' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><List className="mr-3 h-5 w-5 shrink-0" />Lançamentos</Link>)}
                      {hasSummaryPermission && (<Link href="/congregation-summary" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/congregation-summary' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><PieChart className="mr-3 h-5 w-5 shrink-0" />Resumo Diário</Link>)}
                      ...
                      {session?.user?.canExport && (<Link href="/export" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/export' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><Download className="mr-3 h-5 w-5 shrink-0" />Exportar Dados</Link>)}
                      {session?.user?.canDelete && (<Link href="/delete-history" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/delete-history' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><Trash2 className="mr-3 h-5 w-5 shrink-0" />Excluir Histórico</Link>)}
                    </div>
                  )}
                </div>
              )}
              ...
              {canCreate && (
                <div className="mt-3">
                  ...
                  {openCadastros && (
                    <div className="mt-1 space-y-1 pl-8">
                      <Link href="/contributors" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/contributors' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><User className="mr-3 h-5 w-5 shrink-0" />Contribuintes</Link>
                      <Link href="/congregations" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/congregations' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><Building2 className="mr-3 h-5 w-5 shrink-0" />Congregações</Link>
                      <Link href="/suppliers" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/suppliers' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><Building className="mr-3 h-5 w-5 shrink-0" />Fornecedores</Link>
                      <Link href="/classifications" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/classifications' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><ListCheck className="mr-3 h-5 w-5 shrink-0" />Classificações</Link>
                    </div>
                  )}
                </div>
              )}
              ...
              <div className="mt-3">
                ...
                {openSeguranca && (
                  <div className="mt-1 space-y-1 pl-8">
                    {canManageUsers && (<Link href="/users" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/users' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><Users className="mr-3 h-5 w-5 shrink-0" />Usuários</Link>)}
                    {canManageUsers && (<Link href="/profiles" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/profiles' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><UserPen className="mr-3 h-5 w-5 shrink-0" />Perfis</Link>)}
                    <Link href="/profile" className={cn('group flex items-center px-2 py-2 text-sm rounded-md', pathname === '/profile' ? 'bg-primary text-primary-foreground' : 'text-gray-600 hover:bg-gray-50')}><UserCheck className="mr-3 h-5 w-5 shrink-0" />Acesso</Link>
                  </div>
                )}
              </div>
