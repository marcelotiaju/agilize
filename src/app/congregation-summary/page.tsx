...
export default function CongregationSummary() {
  ...
  const totalEntradas = useMemo(() => Number(editFormData.entryTotal) + Number(editFormData.titheTotal) + Number(editFormData.offerValue) + Number(editFormData.missionTotal) + Number(editFormData.circleTotal), [editFormData.entryTotal, editFormData.titheTotal]);
  ...
  const handleEditSummary = (summary: Summary) => {
    ...
    setEditFormData({
      ...
      offerValue: summary.offerValue ?? '',
      votesValue: summary.votesValue ?? '',
      ebdValue: summary.ebdValue ?? '',
      campaignValue: summary.campaignValue ?? '',
                      ...
                      <TableBody>
                        {summaries.map((summary) => (
                          <TableRow key={summary.id}>
                            ...
                            <TableCell>R$ {(summary.offerValue ?? 0).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                        ...
                        <div className="pt-0 mt-0">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="flex flex-col gap-2">
                                  ...
                                  <div className="bg-purple-50 p-1 rounded-lg flex justify-between items-center">
                                      <h5 className="font-medium text-purple-700">Oferta de Culto</h5>
                                      <div className="text-sm font-semibold flex justify-end">
                                          R$ {Number(editFormData.offerValue ?? 0).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                      </div>
                                  </div>                                  
                                  ...
                                  <div className="bg-blue-100 p-1 rounded-lg border-2 border-blue-300">
                                      <div className="flex justify-between items-center">
                                          ...
                                          <div className="text-sm font-extrabold text-blue-800">
                                              {/* Calcula Entradas (entryTotal) + Dízimo (titheTotal) */}
                                              R$ {(Number(editFormData.entryTotal) + Number(editFormData.titheTotal) + Number(editFormData.offerValue) + Number(editFormData.missionTotal) + Number(editFormData.circleTotal)).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div className="flex flex-col gap-4">
                                  ...
                                  {/* 3. CARD TOTAL DE SAÍDAS */}
                                  <div className="bg-red-50 p-1 *:rounded-lg flex justify-between items-center md:mb-60">
                                      <h5 className="font-medium text-red-700">Saídas</h5>
                                      <div className="text-sm font-semibold ">
                                          R$ {Number(editFormData.exitTotal).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                      </div>
                                  ...
                                  <div className="bg-purple-100 p-1 rounded-lg border-2 border-purple-300">
                                      <div className="flex justify-between items-center">
                                          ...
                                          <div className="text-sm font-extrabold text-purple-800">
                                              {/* Calcula (Entrada + Dízimo) - Saída */}
                                              R$ {(
                                                  (Number(editFormData.entryTotal) + Number(editFormData.titheTotal) + Number(editFormData.offerValue) + Number(editFormData.missionTotal) + Number(editFormData.circleTotal)) - Number(editFormData.exitTotal)
                                              ).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                          </div>
                                      </div>
                                  </div>
