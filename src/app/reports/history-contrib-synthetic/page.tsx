...
export default function ReportsPage() {
    ...
    const handleExportExcel = () => {
        ...
        XLSX.writeFile(wb, `Relatorio_Contribuicoes_Sintetico_${selectedYear}.xlsx`);
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="lg:pl-64">
                <div className="p-6">
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-900">Histórico de Contribuições Sintético</h1>
                    </div>
